async function main() {
  ...
  const MyToken = await hre.ethers.getContractFactory("EvieToken");
  ...
  await nft.safeMint(await signer0.getAddress(), "ipfs://QmNqFGDDFHLyegi8KyucUnkmviaGDHFvjJ5XzzuoZYoksh");
